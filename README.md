...
**🔗 [View Code →](https://github.com/lmgamba/Full-Stack_LGS/blob/main/2_e-commerce_front_with_JS/test/product_filter.test.js)**  
...
**🧪 Unit Testing with Jest** | Comprehensive unit testing suite for business logic  
**🖼️ Dynamic DOM Rendering** | JavaScript-generated product cards from JSON data   
**🏗️ Clean Architecture** | Separation of testeable code (logic.js) and UI presentation (script.js)  
...
[![My Skills](https://skillicons.dev/icons?i=react,typescript,angular)](https://skillicons.dev)
 ...
 <details>
As part of continuous learning, I'm expanding into modern frontend frameworks (Angular+React)
while maintaining strong fundamentals in vanilla JavaScript.
...
**Full-Stack Developer Bootcamp** | Upgrade Hub (2025-2026)  
...
---
*This repository showcases hands-on learning through practical projects. Each 
project demonstrates progressive skill development from frontend fundamentals 
